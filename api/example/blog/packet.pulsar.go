...
func (x *BlogPacketData) slowProtoReflect() protoreflect.Message {
	mi := &file_example_blog_packet_proto_msgTypes[0]
...
func (x *fastReflection_BlogPacketData) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		...
		panic(fmt.Errorf("message example.blog.BlogPacketData does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_BlogPacketData) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message example.blog.BlogPacketData does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_BlogPacketData) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	case "example.blog.BlogPacketData.packet":
		if x.Packet == nil {
			return nil
		}
...
func init() {
	file_example_blog_packet_proto_init()
	md_NoData = File_example_blog_packet_proto.Messages().ByName("NoData")
}
...
func (x *NoData) slowProtoReflect() protoreflect.Message {
	mi := &file_example_blog_packet_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_NoData) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: example.blog.NoData"))
		}
		panic(fmt.Errorf("message example.blog.NoData does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_NoData) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message example.blog.NoData does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_NoData) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in example.blog.NoData", d.FullName()))
	}
	panic("unreachable")
}
...
func (x *fastReflection_IbcPostPacketData) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "example.blog.IbcPostPacketData.content":
		return x.Content != ""
	case "example.blog.IbcPostPacketData.creator":
		return x.Creator != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_IbcPostPacketData) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "example.blog.IbcPostPacketData.creator":
		panic(fmt.Errorf("field creator of message example.blog.IbcPostPacketData is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: example.blog.IbcPostPacketData"))
		}
...
// 	protoc        (unknown)
// source: example/blog/packet.proto
...
func (*BlogPacketData) Descriptor() ([]byte, []int) {
	return file_example_blog_packet_proto_rawDescGZIP(), []int{0}
}
...
var file_example_blog_packet_proto_rawDesc = []byte{
	...
	0x08, 0x0a, 0x06, 0x4e, 0x6f, 0x44, 0x61, 0x74, 0x61, 0x22, 0x5d, 0x0a, 0x11, 0x49, 0x62, 0x63,
	...
	0x07, 0x63, 0x72, 0x65, 0x61, 0x74, 0x6f, 0x72, 0x22, 0x2a, 0x0a, 0x10, 0x49, 0x62, 0x63, 0x50,
	0x6f, 0x73, 0x74, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x41, 0x63, 0x6b, 0x12, 0x16, 0x0a, 0x06,
	0x70, 0x6f, 0x73, 0x74, 0x49, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x70, 0x6f,
	0x73, 0x74, 0x49, 0x64, 0x42, 0x8a, 0x01, 0x0a, 0x10, 0x63, 0x6f, 0x6d, 0x2e, 0x65, 0x78, 0x61,
	0x6d, 0x70, 0x6c, 0x65, 0x2e, 0x62, 0x6c, 0x6f, 0x67, 0x42, 0x0b, 0x50, 0x61, 0x63, 0x6b, 0x65,
	0x74, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x18, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c,
...
var (
	file_example_blog_packet_proto_rawDescOnce sync.Once
	file_example_blog_packet_proto_rawDescData = file_example_blog_packet_proto_rawDesc
)

func file_example_blog_packet_proto_rawDescGZIP() []byte {
	file_example_blog_packet_proto_rawDescOnce.Do(func() {
		file_example_blog_packet_proto_rawDescData = protoimpl.X.CompressGZIP(file_example_blog_packet_proto_rawDescData)
	})
...
func file_example_blog_packet_proto_init() {
	if File_example_blog_packet_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_example_blog_packet_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_example_blog_packet_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*NoData); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_example_blog_packet_proto_goTypes,
		DependencyIndexes: file_example_blog_packet_proto_depIdxs,
		MessageInfos:      file_example_blog_packet_proto_msgTypes,
	}.Build()
	File_example_blog_packet_proto = out.File
	file_example_blog_packet_proto_rawDesc = nil
	file_example_blog_packet_proto_goTypes = nil
	file_example_blog_packet_proto_depIdxs = nil
}
