...
func init() {
	...
	md_Post = File_example_blog_post_proto.Messages().ByName("Post")
...
func (x *Post) slowProtoReflect() protoreflect.Message {
	mi := &file_example_blog_post_proto_msgTypes[0]
...
func (x *fastReflection_Post) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "example.blog.Post.id":
		return x.Id != uint64(0)
	case "example.blog.Post.title":
		return x.Title != ""
	case "example.blog.Post.content":
		return x.Content != ""
	case "example.blog.Post.creator":
		return x.Creator != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: example.blog.Post"))
		}
		panic(fmt.Errorf("message example.blog.Post does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Post) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message example.blog.Post does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Post) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "example.blog.Post.id":
		panic(fmt.Errorf("field id of message example.blog.Post is not mutable"))
	case "example.blog.Post.title":
		panic(fmt.Errorf("field title of message example.blog.Post is not mutable"))
	case "example.blog.Post.content":
		panic(fmt.Errorf("field content of message example.blog.Post is not mutable"))
	case "example.blog.Post.creator":
		panic(fmt.Errorf("field creator of message example.blog.Post is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: example.blog.Post"))
		}
...
func (x *fastReflection_Post) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in example.blog.Post", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: example/blog/post.proto
...
func (*Post) Descriptor() ([]byte, []int) {
	return file_example_blog_post_proto_rawDescGZIP(), []int{0}
}
...
var File_example_blog_post_proto protoreflect.FileDescriptor

var file_example_blog_post_proto_rawDesc = []byte{
	0x0a, 0x17, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2f, 0x62, 0x6c, 0x6f, 0x67, 0x2f, 0x70,
	0x6f, 0x73, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0c, 0x65, 0x78, 0x61, 0x6d, 0x70,
	0x6c, 0x65, 0x2e, 0x62, 0x6c, 0x6f, 0x67, 0x22, 0x60, 0x0a, 0x04, 0x50, 0x6f, 0x73, 0x74, 0x12,
	...
	0x52, 0x07, 0x63, 0x72, 0x65, 0x61, 0x74, 0x6f, 0x72, 0x42, 0x88, 0x01, 0x0a, 0x10, 0x63, 0x6f,
	0x6d, 0x2e, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2e, 0x62, 0x6c, 0x6f, 0x67, 0x42, 0x09,
	0x50, 0x6f, 0x73, 0x74, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x18, 0x65, 0x78, 0x61,
...
var (
	file_example_blog_post_proto_rawDescOnce sync.Once
	file_example_blog_post_proto_rawDescData = file_example_blog_post_proto_rawDesc
)

func file_example_blog_post_proto_rawDescGZIP() []byte {
	file_example_blog_post_proto_rawDescOnce.Do(func() {
		file_example_blog_post_proto_rawDescData = protoimpl.X.CompressGZIP(file_example_blog_post_proto_rawDescData)
	})
	return file_example_blog_post_proto_rawDescData
}

var file_example_blog_post_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_example_blog_post_proto_goTypes = []interface{}{
	(*Post)(nil), // 0: example.blog.Post
}
var file_example_blog_post_proto_depIdxs = []int32{
...
func init() { file_example_blog_post_proto_init() }
func file_example_blog_post_proto_init() {
	if File_example_blog_post_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_example_blog_post_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Post); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_example_blog_post_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_example_blog_post_proto_goTypes,
		DependencyIndexes: file_example_blog_post_proto_depIdxs,
		MessageInfos:      file_example_blog_post_proto_msgTypes,
	}.Build()
	File_example_blog_post_proto = out.File
	file_example_blog_post_proto_rawDesc = nil
	file_example_blog_post_proto_goTypes = nil
	file_example_blog_post_proto_depIdxs = nil
}
