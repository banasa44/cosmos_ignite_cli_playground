...
func init() {
	file_example_blog_genesis_proto_init()
...
func (x *GenesisState) slowProtoReflect() protoreflect.Message {
	mi := &file_example_blog_genesis_proto_msgTypes[0]
...
func (x *fastReflection_GenesisState) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "example.blog.GenesisState.params":
		return x.Params != nil
	...
	default:
		...
		panic(fmt.Errorf("message example.blog.GenesisState does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_GenesisState) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message example.blog.GenesisState does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_GenesisState) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in example.blog.GenesisState", d.FullName()))
	}
	panic("unreachable")
}
...
func (*GenesisState) Descriptor() ([]byte, []int) {
	return file_example_blog_genesis_proto_rawDescGZIP(), []int{0}
}
...
var file_example_blog_genesis_proto_rawDesc = []byte{
	0x0a, 0x1a, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2f, 0x62, 0x6c, 0x6f, 0x67, 0x2f, 0x67,
	0x65, 0x6e, 0x65, 0x73, 0x69, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0c, 0x65, 0x78,
	0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2e, 0x62, 0x6c, 0x6f, 0x67, 0x1a, 0x11, 0x61, 0x6d, 0x69, 0x6e,
...
var (
	file_example_blog_genesis_proto_rawDescOnce sync.Once
	file_example_blog_genesis_proto_rawDescData = file_example_blog_genesis_proto_rawDesc
)

func file_example_blog_genesis_proto_rawDescGZIP() []byte {
	file_example_blog_genesis_proto_rawDescOnce.Do(func() {
		file_example_blog_genesis_proto_rawDescData = protoimpl.X.CompressGZIP(file_example_blog_genesis_proto_rawDescData)
	})
	return file_example_blog_genesis_proto_rawDescData
}

var file_example_blog_genesis_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
...
func file_example_blog_genesis_proto_init() {
	if File_example_blog_genesis_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_example_blog_genesis_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_example_blog_genesis_proto_goTypes,
		DependencyIndexes: file_example_blog_genesis_proto_depIdxs,
		MessageInfos:      file_example_blog_genesis_proto_msgTypes,
	}.Build()
	File_example_blog_genesis_proto = out.File
	file_example_blog_genesis_proto_rawDesc = nil
	file_example_blog_genesis_proto_goTypes = nil
	file_example_blog_genesis_proto_depIdxs = nil
}
