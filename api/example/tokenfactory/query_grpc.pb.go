...
const (
	Query_Params_FullMethodName   = "/example.tokenfactory.Query/Params"
	Query_Denom_FullMethodName    = "/example.tokenfactory.Query/Denom"
	Query_DenomAll_FullMethodName = "/example.tokenfactory.Query/DenomAll"
)
