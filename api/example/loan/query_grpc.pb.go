...
const (
	Query_Params_FullMethodName  = "/example.loan.Query/Params"
	Query_Loan_FullMethodName    = "/example.loan.Query/Loan"
	Query_LoanAll_FullMethodName = "/example.loan.Query/LoanAll"
)
